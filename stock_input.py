...
# Declare constants
number_shares = int(input('How many shares are you buying? '))
buy_price = float(input('What is the price your paying per share? '))
commission_rate = 0.03
sell_price = float(input(' What is the price your selling per share? '))
